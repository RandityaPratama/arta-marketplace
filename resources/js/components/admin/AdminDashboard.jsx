...
export default function AdminDashboard() {
  ...
  const recentActivity = [
    { id: 1, action: "Randitya mengunggah produk baru", time: "2 jam lalu", important: true },
    { id: 2, action: "Budi membeli Samsung S24 Ultra", time: "5 jam lalu", important: false },
    { id: 3, action: "Dina memperbarui profil", time: "1 hari lalu", important: false },
    { id: 4, action: "Eko memberi ulasan", time: "1 hari lalu", important: false },
  ];
      ...
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-800">
                Aktivitas Terbaru ({recentActivity.length})
              </h3>
              <Button 
                variant="primary" 
                size="sm" 
            ...
            <div className="space-y-3">
              {recentActivity.map((activity) => (
                <div key={activity.id} className="flex items-start gap-3">
                  {/* ✅ Titik merah untuk aktivitas penting */}
                  {activity.important ? (
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold text-gray-800">
                Produk Terbaru ({latestProducts.length})
              </h3>
              <Button 
                variant="primary" 
                size="sm" 
                onClick={() => navigate("/admin/products", { state: { defaultTab: "aktif" } })}
              >
                Lihat Semua
              </Button>
            </div>
